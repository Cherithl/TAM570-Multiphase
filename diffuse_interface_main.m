...
[U,V,T,z,w,Dh,X,Y,Grr,Grs,Gss,Bl,Xr,Rx,Jac,Q,glo_num,Mu,Mv,Mp,Mt,ifnull,unxa_v,unya_v,BC_all,dA]=set_sem_all(N, Nelx, Nely, annulus_flag);
...
Phi1=Phi;Phi2=Phi;Phi3=Phi; K1=O;K2=O;K3=O;
